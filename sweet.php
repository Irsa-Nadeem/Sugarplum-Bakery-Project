...
{
    $do_name=$_POST['sname'];
    $do_price=$_POST['sprice'];
    $do_image=$_FILES['spic']['name'];
    $do_temp_image_name=$_FILES['spic']['tmp_name'];
    $do_folder='addc/'.$do_image;

   $insert_query=mysqli_query($conn,"insert into `spic` (image,name,price) values ('$do_image','$do_name',' $do_price')");
  if($insert_query){
			...
			<div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
				...
				<ul>
					                                                                        <li><a href="admin.php">Home</a></li>
                                                                                                                <li class="active"><a href="sweet.php">Insert Sweet</a></li>
				...
				<div class="row">
					...
					<div class="col-lg-8 contact_col">
						<div class="contact_form" style="width: 100%; ">
							...
							<div class="contact_subject" style="font-size: 16px;">Add Sweet!	
							...
							<div class="contact_form_container" style="width: 50%; margin-left:190px">
								<form action="" method="post" id="contact_form" class="contact_form" enctype="multipart/form-data">
                                                                             ...
                                                                             <input type="text" id="sname" name="sname" class="contact_input" placeholder="Enter Sweet Name"
										 required="required">

                                                                             <input type="text" min="0" id="sprice" name="sprice" class="contact_input"
										placeholder="Enter Sweet Price"  required="required">


									       <input type="file" id="spic" name="spic" class="contact_input" required="required" accept="image/png, image/jpeg, image/jpg, image/avif, image/webp" style="line-height: 2em; padding: 5px; font-style:italic;">
