...
if(isset($_POST['addcbtn']))
{
    ...
    $do_price=$_POST['doprice'];
    $do_image=$_FILES['dopic']['name'];
    $do_temp_image_name=$_FILES['dopic']['tmp_name'];
    $do_folder='addc/'.$do_image;

   $insert_query=mysqli_query($conn,"insert into `dpic` (image,name,price) values ('$do_image','$do_name',' $do_price')");
  if($insert_query){

      move_uploaded_file($do_temp_image_name, $do_folder);
			...
			<div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
				...
				<ul>
					                                                                        <li><a href="admin.php">Home</a></li>
                                                                                                                <li class="active"><a href="donuts.php">Insert Donuts</a></li>
				...
				<div class="row">
					...
					<div class="col-lg-8 contact_col">
						<div class="contact_form" style="width: 100%; ">
							...
							<div class="contact_subject" style="font-size: 16px;">Add Donuts!	
							...
							<div class="contact_form_container" style="width: 50%; margin-left:190px">
								<form action="" method="post" id="contact_form" class="contact_form" enctype="multipart/form-data">
										...
										placeholder="Enter Donuts Price"  required="required">
