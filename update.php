...
{
$update_id= $_POST['id'];
$update_name= $_POST['cakename'];
$update_price= $_POST['cakeprice'];
$update_pic= $_FILES['cakepic']['name'];
$update_temp_pic= $_FILES['cakepic']['tmp_name'];
$update_folder='addc/'.$update_pic;


 $update_query = mysqli_query($conn, "UPDATE `cpic` set image='$update_pic', name='$update_name', price='$update_price' WHERE id=$update_id");
  if($update_query){
		...
		<div class="menu trans_500">
			<div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
				...
				<ul>
														...
														<li><a href="cakes.php">Insert Cakes</a></li>
														<li><a href="viewcakes.php">Modify Cakes</a></li>
														<li class="active"><a href="update.php">Update Cakes</a></li>
				...
				<div class="row">
					...
					<div class="col-lg-8 contact_col">
						<div class="contact_form" style="width: 100%; ">
							...
							<div class="contact_subject" style="font-size: 16px;">Update cakes!	
							...
							<div class="contact_form_container" style="width: 50%; margin-left:190px">
                                                          <?php
                                                            ...
                                                            {
                                                                 $edit_id= $_GET['edit'];
                                                                 $edit_query = mysqli_query($conn, "SELECT* FROM `cpic` WHERE id = $edit_id");
                                                                  ...
                                                                  while($fetch_data=mysqli_fetch_assoc($edit_query))
                                                                   {
                                                                     ...
                                                                     <form action="" method="post" id="contact_form" class="contact_form" enctype="multipart/form-data">
                                                                             ...
                                                                             <input type="text" id="cakename" name="cakename" class="contact_input" placeholder="Enter Cake Name"
										 required="required" value="<?php echo $fetch_data['name']?>">

                                                                             <input type="text" min="0" id="cakeprice" name="cakeprice" class="contact_input"
										placeholder="Enter Cake Price"  required="required" value="<?php echo $fetch_data['price']?>">


									       <input type="file" id="cakepic" name="cakepic" class="contact_input" required="required" accept="image/png, image/jpeg, image/jpg, image/avif, image/webp" style="line-height: 2em; padding: 5px; font-style:italic;">
									...
									<button class="contact_button" id="update_button" name="updcbtn" style="width:130px; margin-right:10px; margin-left:-2px; outline:none;">Update</button>
                                                                        <button class="contact_button" id="cancel_button" name="cancbtn" style="width:130px; margin-right:10px; margin-left:-2px; outline:none;"><a href="viewcakes.php" style="color:white;">Cancel</a></button>
