			...
			<div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
				...
				<ul>
					                                                                        <li><a href="admin.php">Home</a></li>
                                                                                                                ...
                                                                                                                <li class="active"><a href="viewdonuts.php">Modify Donuts</a></li>
			        </ul>
			</div>
		</div>
					 ...
					 <div class="col-lg-4 info_box_col" style="margin-top:25px;"><br><br><br>
						<div class="info_box">
							...
							<div class="info_content" style="background-color:#fcfff7;">
				                          ...
				                          <button class="contact_button" id="contact_button" name="editcbtn" style="width:130px; margin-right:10px; margin-left:-2px; outline:none;"><a href="updatedonuts.php?edit=<?php echo $row['id']?>" style="color:white;">Edit</a></button>
                                                          <button class="contact_button" style="width:130px; margin-left:2px; outline:none;"><a href="deletedonuts.php?delete=<?php echo $row['id']?>" onclick="return confirm('Are you sure? You want to delete this product');" style="color:white;">Delete</a></button>
