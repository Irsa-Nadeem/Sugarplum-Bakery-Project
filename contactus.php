...
if(isset($_POST['conbtn']))
{
   ...
   $insert_query=mysqli_query($conn,"insert into `contact` (name,email,subject,message) values ('$user_name','$user_email','$user_subject','$user_msg')");
  if($insert_query){

      $display_msg="Submitted Sucessfully";
...
?>
		...
		<div class="home">
                    <div class="cta">
			<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="aboutpic/contact.jpg"
				data-speed="0.8"></div>
		    </div>
					...
					<div class="contact_form">
						...
						<div class="contact_form_container">
							<form action="#" method="post" id="contact_form" class="contact_form">
								<input type="text" id="contact_input" class="contact_input" placeholder="Your Name" required="required" name="name">
								<input type="email" id="contact_email" class="contact_input" placeholder="Your E-mail" required="required" name="email">
								<input type="text" id="contact_subject" class="contact_input" placeholder="Subject" required="required" name="subject">
								...
								<button class="contact_button" id="contact_button" style="outline:none;" name="conbtn">send message</button>
							</form>
                                                      <br><br><br>
                                                  <?php
					...
					<div class="row">
						<div class="col-lg-3 offset-lg-1">
							<div class="contact_info_list">
								...
								<ul>
									<li><span>Address: </span>12-A, Street 5, Phase 5, DHA, Lahore</li>
									<li><span>Landline No: </span>0483 123456</li>
									<li><span>Phone No: </span>+92 3211256778</li>
								</ul>
							</div>
						</div>
						<div class="col-lg-4">
							<div class="contact_info_list contact_info_list_2">
								<ul>
									...
									<li><span>WhatsApp No: </span>+92 3211256778</li>
									<li><span>Instagram Account: </span>Sugarplaum_Bakery</li>
									<li><span>Email: </span>sugarplum@gmail.com</li>
								</ul>
							</div>
						</div>
						<div class="col-lg-3">
