				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-4 contact_col">
							<div class="info_form_container" style="width: 240%; margin-left: 150px; background-color:#f0f0f0;">
                                                           ...
                                                           <?php 
                                                            ...
                                                            if(mysqli_num_rows($display_product)>0)
                                                            {
                                                              ...
                                                              while($row=mysqli_fetch_assoc($display_product))
                                                             {
                                                                 ...
                                                                 ?>
                                                                <br><br>
                                                                <div style="width: 80%; font-style:italic;" class="centerdiv">
                                                                    <p class="one"><b><?php echo $num?>) Customer Name: <?php echo $row['name']?></b></p>
                                                                    <p class="one"><b>Customer Email Address: <?php echo $row['email']?></b></p>
                                                                    <p class="one"><b>Customer Contact Number: <?php echo $row['contact']?></b></p>
                                                                    <p class="one"><b>Customer City: <?php echo $row['city']?></b></p>
                                                                    <p class="one"><b>Customer Address: <?php echo $row['address']?></b></p>
                                                                    <p class="one"><b>Customer Ordered Items: <?php echo $row['item']?></b></p>
                                                                    <p class="one"><b>Total price: <?php echo $row['total']?></b></p>
                                                                </div>
                                                                <br>
