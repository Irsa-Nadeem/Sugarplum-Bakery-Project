...
if(isset($_POST['addcbtn']))
{
    ...
    $cake_image=$_FILES['cakepic']['name'];
    $cake_temp_image_name=$_FILES['cakepic']['tmp_name'];
    $cake_folder='addc/'.$cake_image;

   $insert_query=mysqli_query($conn,"insert into `cpic` (image,name,price) values ('$cake_image','$cake_name',' $cake_price')");
  if($insert_query){

      move_uploaded_file($cake_temp_image_name, $cake_folder);
			...
			<div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
				...
				<ul>
					                                                                        <li><a href="admin.php">Home</a></li>
                                                                                                                <li class="active"><a href="cakes.php">Insert Cakes</a></li>
				...
				<div class="row">
					...
					<div class="col-lg-8 contact_col">
						<div class="contact_form" style="width: 100%; ">
							...
							<div class="contact_subject" style="font-size: 16px;">Add cakes!	
							...
							<div class="contact_form_container" style="width: 50%; margin-left:190px">
								<form action="" method="post" id="contact_form" class="contact_form" enctype="multipart/form-data">
										...
										placeholder="Enter Cake Price"  required="required">
