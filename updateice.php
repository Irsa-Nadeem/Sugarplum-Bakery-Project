...
if(isset($_POST['updcbtn']))
{
$update_id= $_POST['id'];
$update_name= $_POST['icename'];
$update_price= $_POST['iceprice'];
$update_pic= $_FILES['icepic']['name'];
$update_temp_pic= $_FILES['icepic']['tmp_name'];
$update_folder='addc/'.$update_pic;


 $update_query = mysqli_query($conn, "UPDATE `ipic` set image='$update_pic', name='$update_name', price='$update_price' WHERE id=$update_id");
  if($update_query){

      move_uploaded_file($update_temp_pic, $update_folder);
      header('location:viewice.php');
}
else
{
$display_msg="Unable to Update";

}
}

if(isset($_POST['cancbtn']))
{
header('location:viewice.php');
}
?>
		...
		<div class="menu trans_500">
			<div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
				...
				<ul>
														...
														<li><a href="icecream.php">Insert Icecream</a></li>
														<li><a href="viewice.php">Modify Icecream</a></li>
														<li class="active"><a href="updateice.php">Update Icecream</a></li>
				...
				<div class="row">
					...
					<div class="col-lg-8 contact_col">
						<div class="contact_form" style="width: 100%; ">
							...
							<div class="contact_subject" style="font-size: 16px;">Update Icecream!	
							...
							<div class="contact_form_container" style="width: 50%; margin-left:190px">
                                                          <?php
                                                            ...
                                                            {
                                                                 $edit_id= $_GET['edit'];
                                                                 $edit_query = mysqli_query($conn, "SELECT* FROM `ipic` WHERE id = $edit_id");
                                                                  ...
                                                                  while($fetch_data=mysqli_fetch_assoc($edit_query))
                                                                   {
                                                                     ...
                                                                     <form action="" method="post" id="contact_form" class="contact_form" enctype="multipart/form-data">
                                                                             <img src="addc/<?php echo $fetch_data['image'] ?>" alt="error" style="width:366px; height:200px;">
                                                                               <br><br>
                                                                             <input type="hidden" value="<?php echo $fetch_data['id']?>" name="id">
                                                                             <input type="text" id="cakename" name="icename" class="contact_input" placeholder="Enter Icecream Name"
										 required="required" value="<?php echo $fetch_data['name']?>">

                                                                             <input type="text" min="0" id="cakeprice" name="iceprice" class="contact_input"
										placeholder="Enter Icecream Price"  required="required" value="<?php echo $fetch_data['price']?>">


									       <input type="file" id="cakepic" name="icepic" class="contact_input" required="required" accept="image/png, image/jpeg, image/jpg, image/avif, image/webp" style="line-height: 2em; padding: 5px; font-style:italic;">

									<br>
									<button class="contact_button" id="update_button" name="updcbtn" style="width:130px; margin-right:10px; margin-left:-2px; outline:none;">Update</button>
                                                                        <button class="contact_button" id="cancel_button" name="cancbtn" style="width:130px; margin-right:10px; margin-left:-2px; outline:none;"><a href="viewice.php" style="color:white;">Cancel</a></button>
