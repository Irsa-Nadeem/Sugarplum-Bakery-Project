...
{
 $display_msg="Product already added to cart";
}
else
{
$insert=mysqli_query($conn,"insert into `cart` (image,name,price,quantity) values ('$pic','$name',' $price', '$quantity')");

$display_msg="Product added to cart";
}
			...
			<div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
				...
				<ul>
					<li><a href="index.php">Home</a></li>
														<li class="active"><a href="menu.php">Cakes</a></li>
														<li><a href="menupas.php">Pasteries</a></li>
														<li><a href="menudonuts.php">Donuts</a></li>
														<li><a href="menucup.php">Cup cakes</a></li>
														<li><a href="menuice.php">Icecream</a></li>
														<li><a href="menusweet.php">Sweet</a></li>
...
<div class="info">
			...
			<div class="container">
				...
				<div class="row row-eq-height">
                                    <?php 
                                                            $display_product=mysqli_query($conn,"select* from `cpic`");
					 ...
					 <div class="col-lg-4 info_box_col" style="margin-top:25px;"><br><br>
						<div class="info_box">
							...
							<div class="info_content" style="background-color:#fcfff7;">
				                          ...
				                          <input type="hidden" name="pic" value="<?php echo $row['image']?>">
                                                          <input type="hidden" name="name" value="<?php echo $row['name']?>">
                                                          <input type="hidden" name="price" value="<?php echo $row['price']?>">
                                                       
                                                          <button class="contact_button" style="width:200px; margin-left:30px; margin-top:9px; outline:none;" name="add"><a>Add to Cart</a></button>
