...
{
    $pas_name=$_POST['pasname'];
    $pas_price=$_POST['pasprice'];
    $pas_image=$_FILES['paspic']['name'];
    $pas_temp_image_name=$_FILES['paspic']['tmp_name'];
    $pas_folder='addc/'.$pas_image;

   $insert_query=mysqli_query($conn,"insert into `ppic` (image,name,price) values ('$pas_image','$pas_name',' $pas_price')");
  if($insert_query){

      move_uploaded_file($pas_temp_image_name, $pas_folder);
      $display_msg="Item Added Sucessfully";
      }
else
{
			...
			<div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
				...
				<ul>
					                                                                        <li><a href="admin.php">Home</a></li>
                                                                                                                <li class="active"><a href="pasteries.php">Insert Pasteries</a></li>
				...
				<div class="row">
					...
					<div class="col-lg-8 contact_col">
						<div class="contact_form" style="width: 100%; ">
							...
							<div class="contact_subject" style="font-size: 16px;">Add Pasteries!	
							...
							<div class="contact_form_container" style="width: 50%; margin-left:190px">
								<form action="" method="post" id="contact_form" class="contact_form" enctype="multipart/form-data">
										...
										placeholder="Enter Pastery Price"  required="required">
									...
									<br>
									<button class="contact_button" id="contact_button" name="addcbtn" style="outline:none;">Add Product</button>
									<br><br><br>
								</form>
                                                            <?php
