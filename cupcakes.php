...
{
    $cup_name=$_POST['cuname'];
    $cup_price=$_POST['cuprice'];
    $cup_image=$_FILES['cupic']['name'];
    $cup_temp_image_name=$_FILES['cupic']['tmp_name'];
    $cup_folder='addc/'.$cup_image;

   $insert_query=mysqli_query($conn,"insert into `cup` (image,name,price) values ('$cup_image','$cup_name',' $cup_price')");
  if($insert_query){

      move_uploaded_file($cup_temp_image_name, $cup_folder);
			...
			<div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
				...
				<ul>
					                                                                        <li><a href="admin.php">Home</a></li>
                                                                                                                <li class="active"><a href="cupcakes.php">Insert Cupcakes</a></li>
                                                                                                                <li><a href="viewcup.php">Modify Cupcakes</a></li>
				...
				<div class="row">
					...
					<div class="col-lg-8 contact_col">
						<div class="contact_form" style="width: 100%; ">
							...
							<div class="contact_subject" style="font-size: 16px;">Add Cupcakes!	
							...
							<div class="contact_form_container" style="width: 50%; margin-left:190px">
								<form action="" method="post" id="contact_form" class="contact_form" enctype="multipart/form-data">
										...
										placeholder="Enter Cupcake Price"  required="required">
