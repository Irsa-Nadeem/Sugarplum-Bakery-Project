...
if(isset($_POST['signbtn']))
{
   ...
   $select_query=mysqli_query($conn,"select* from `admin` where email='$user_email' and password='$user_password'");
   ...
   {
      $insert_query=mysqli_query($conn,"insert into `admin` (name,email,password) values ('$user_name','$user_email','$user_password')");
      if($insert_query)
      {
			...
			<div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
				...
				<ul>
      														...
      														<li><a href="Orders.php">Orders</a></li>
											                        <li class="active"><a href="adminsignup.php">Sign Up</a></li>
						...
						<div class="contact_form" style="width: 100%; ">
							...
							<div class="contact_form_container" style="width: 50%; margin-left:190px">
								<form action="" method="post" id="contact_form" class="contact_form">
									...
									<button class="contact_button" id="contact_button" name="signbtn" style="outline:none;">Sign Up</button>
									<br><br><br>
								</form>
                                                           <?php
