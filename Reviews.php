...
if(isset($_POST['resbtn']))
{
    ...
    $user_email=$_POST['femail'];
    $user_subject=$_POST['fsubject'];
    $user_msg=$_POST['fmessage'];

   
   $insert_query=mysqli_query($conn,"insert into `reviews` (name,email,subject,message) values ('$user_name','$user_email','$user_subject','$user_msg')");
  if($insert_query){

      $display_msg="Review Added Sucessfully";
      header('location:Reviews.php');
}
else
{
  $display_msg="Unable to Add";
}
...
<!-- Travel Forum section starts here-->


<h2 style="text-align: center; color: black; font-family: 'Montserrat', sans-serif; font-weight: bold;">What our customers say about us</h2><br>
<div id="myCarousel" class="carousel slide text-center" data-ride="carousel">
    ...
    <div class="image_center"> <img src="aboutpic/person.png" class="img-circle person" alt="Random Name"> </div>

    <div class="carousel-inner" role="listbox">
        <?php
            $display_product=mysqli_query($conn,"select* from `reviews`");
            if(mysqli_num_rows($display_product)>0) {
                $firstItem = true; // Flag for the first item
                while($row=mysqli_fetch_assoc($display_product)) {
                    ?>

                    <div class="item <?php echo $firstItem ? 'active' : ''; ?>">
                        <h4><i class="fa fa-quote-left" style="font-size:48px;color:black"></i><br><br><?php echo $row['message']?><br><span><?php echo $row['name']?></span></h4>
                    </div>
                    <?php
    ...
    <a class="left carousel-control" href="#myCarousel" role="button" data-slide="prev" style="margin-top:-80px;">
        <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
        <span class="sr-only">Previous</span>
    </a>
    <a class="right carousel-control" href="#myCarousel" role="button" data-slide="next" style="margin-top:-80px;">
				...
				<div class="row">
					...
					<div class="col-lg-8 contact_col">
						<div class="contact_form" style="width: 100%; ">
							...
							<div class="contact_subject" style="font-size: 16px;">Write a review about your experience at Sugarplum Bakery!
							...
							<div class="contact_form_container" style="width: 50%; margin-left:190px">
								<form action="" method="post" id="contact_form" class="contact_form">
									<input type="text" id="fname" name="fname" class="contact_input" placeholder="Your Name"
										 required="required">
									<input type="email" id="femail" name="femail" class="contact_input"
										placeholder="Your E-mail"  required="required">
									<input type="text" id="fsubject" name="fsubject" class="contact_input" placeholder="Subject"
										 required="required">
									<textarea class="contact_input contact_textarea" id="fmessage" name="fmessage"
										placeholder="Message" required="required"></textarea><br>
									<button class="contact_button" id="contact_button" name="resbtn" style="outline:none;">Submit Response</button>
									<br><br><br>
								</form>
                                                           <?php
