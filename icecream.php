...
{
    $ice_name=$_POST['icename'];
    $ice_price=$_POST['iceprice'];
    $ice_image=$_FILES['icepic']['name'];
    $ice_temp_image_name=$_FILES['icepic']['tmp_name'];
    $ice_folder='addc/'.$ice_image;

   $insert_query=mysqli_query($conn,"insert into `ipic` (image,name,price) values ('$ice_image','$ice_name',' $ice_price')");
  if($insert_query){

      move_uploaded_file($ice_temp_image_name, $ice_folder);
			...
			<div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
				...
				<ul>
					                                                                        <li><a href="admin.php">Home</a></li>
                                                                                                                <li class="active"><a href="icecream.php">Insert Icecream</a></li>
				...
				<div class="row">
					...
					<div class="col-lg-8 contact_col">
						<div class="contact_form" style="width: 100%; ">
							...
							<div class="contact_subject" style="font-size: 16px;">Add Icecream!	
							...
							<div class="contact_form_container" style="width: 50%; margin-left:190px">
								<form action="" method="post" id="contact_form" class="contact_form" enctype="multipart/form-data">
										...
										placeholder="Enter Icecream Price"  required="required">
